	...
	function (width, height) {
		...
		return _List_fromArray(
			[
				...
				interval: months,
				length: $elm$core$List$length(months),
				...
				interval: weekdays,
				length: $elm$core$List$length(weekdays),
				...
				interval: days,
				length: $elm$core$List$length(days),
				...
				interval: hours,
				length: $elm$core$List$length(hours),
				...
				interval: minutes,
				length: $elm$core$List$length(minutes),
				...
				interval: seconds,
				length: $elm$core$List$length(seconds),
...
var $author$project$Main$init = function (_v0) {
	...
	return _Utils_Tuple2(
		{
			clockArms: A2($author$project$Main$createClockArms, width, height),
			delta: 0,
			height: height,
			time: $elm$time$Time$millisToPosix(currentTime),
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UpdateTime':
				...
				var newClockArms = A2($elm$core$List$map, updateAngle, model.clockArms);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{clockArms: newClockArms, time: newTime}),
					$elm$core$Platform$Cmd$none);
			default:
				var newDelta = msg.a;
				return _Utils_Tuple2(
